...
For Roadborne, every table entry is either owner-selected or Unknown. Do not turn an example
budget, common engine convention, or this reference into a Roadborne decision. Evaluate visual
quality through the selected gameplay camera and verify the exact Godot import/runtime result.
...
| Handoff | Source, exports, textures, raw previews, and the existing Roadborne provenance/checksum record are complete |
