...
For Roadborne, this is a Candidate-authoring aid only. Read WorldDesign.md, UI_DESIGN.md,
WORLD_PREVIEW.md, outstanding_questions.md ART-Q01 through ART-Q05, and the owner's active
instruction first. The grounded stylized-realism thesis and comparative visual floor are recorded;
complete character, monster, gear, effect, UI, icon, and domain-lighting rules are not. Do not
promote a visual target or fill those gaps on the owner's behalf.
...
6. Present this target for owner approval before producing a large catalog.
