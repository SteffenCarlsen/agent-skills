...
Use `../../assets/builtin_templates/codex-grid-layout-library/artifact-tool-compose/template-registry.json` to select individual exact modules. The modules deliberately contain no JSX.
