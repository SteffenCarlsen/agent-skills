...
Use when editing an existing PPTX or when the user designates a presentation as
the visual reference or template. A PPTX supplied only as source material does
not establish the visual design.
